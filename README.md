...
Hydrology · Spatial Data Analysis · Modeling
</p>
...
<p align="left">
안녕하십니까, 서울시립대학교 공간정보공학과에 재학 중인 학부생입니다.<br>
공간 데이터 기반 분석과 수문 모델링에 관심을 가지고 있으며, 강수-유출 관계 및 공간적 특성 분석을 중심으로 연구를 진행하고 있습니다.<br><br>

Hello, I am an undergraduate student majoring in Geoinformatics at the University of Seoul.<br>
My primary interests lie in spatial data analysis and hydrological modeling, with a focus on precipitation–runoff relationships and spatial characteristics.
</p>
...
• Spatial Data Analysis (GIS 기반 분석)<br>
...
<p align="left">
현재 프로젝트 및 기존 작업 코드들을 지속적으로 업로드하고 있습니다.<br>
GitHub 활용에 있어 아직 미숙한 부분이 있을 수 있지만, 점진적으로 개선해 나가고 있습니다.<br><br>

I am continuously uploading both ongoing and completed projects.<br>
As I am still improving my GitHub workflow, some repositories may evolve over time.
</p>
